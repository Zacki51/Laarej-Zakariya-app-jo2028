...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $nom_sport = filter_input(INPUT_POST, 'nom_sport', FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    try {
        ...
        $queryCheck = "SELECT id_sport FROM SPORT WHERE nom_sport = :param_nom_sport";
        $statementCheck = $connexion->prepare($queryCheck);
        $statementCheck->bindParam(":param_nom_sport", $nom_sport, PDO::PARAM_STR);
        ...
        if ($statementCheck->rowCount() > 0) {
            ...
            $query = "INSERT INTO SPORT (nom_sport) VALUES (:param_nom_sport)";
            $statement = $connexion->prepare($query);
            $statement->bindParam(":param_nom_sport", $nom_sport, PDO::PARAM_STR);
...
<body>
    ...
    <main>
        ...
        <form action="add-sport.php" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir ajouter ce sport ?')">
            ...
            <input type="text" name="nom_sport" id="nom_sport" required>
